...
viewLogin model =
    column [ width (px 300), padding 24, spacing (UI.scaledInt 2), alignTop ]
        ...
        , UI.textField model.username SetUsername "Username"
...
viewRegister model =
    column [ width (px 300), padding 24, spacing (UI.scaledInt 2), alignTop ]
        ...
        , UI.textField model.createName SetCreateName "Name"
        , UI.textField model.createUsername SetCreateUsername "Username"
